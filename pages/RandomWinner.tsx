...
const RandomWinner: React.FC = () => {
  ...
  return (
    <Layout title="Lucky Winner" showBack>
        ...
        <div className="w-full max-w-md backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl rounded-3xl p-6 text-center">
          ...
          <div className="flex justify-center mb-4">
            <div className="bg-white/20 p-4 rounded-full shadow-inner">
              <AlertTriangle className="text-pink-300" size={32} />
            </div>
          </div>

          {/* Title */}
          <h2 className="text-xl font-bold text-white mb-2">
            Lucky Winner Under Maintenance
          </h2>

          {/* Subtitle */}
          <p className="text-sm text-gray-200 mb-6">
            Monthly jackpot system is temporarily unavailable.<br />
          ...
          <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl p-4 mb-6">
            ...
            <div className="text-2xl font-mono font-bold text-pink-200 tracking-widest">
      ...
      {/* Background Glow */}
      <div className="fixed inset-0 -z-10 bg-gradient-to-br from-black via-purple-900 to-black opacity-95"></div>
    </Layout>
  );
};
